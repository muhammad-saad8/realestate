                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <?php endif; ?>
                                <input type="submit" id="search_property" class="btn btn-default d-inline-block"
                                ...
                                <ul class="ere-dashboard-actions">
                                    ...
                                    switch ($property->post_status) {
                                        case 'publish' :
	                                        ...
	                                        if ($prop_featured == 1) {
		                                        $actions['remove_featured'] = array('label' => __('Remove featured', 'essential-real-estate'), 'tooltip' => __('Remove Featured of Property', 'essential-real-estate'), 'nonce' => true, 'confirm' => esc_html__('Are you sure you want to remove featured of property?', 'essential-real-estate'));
	                                        }
