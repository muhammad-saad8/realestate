...
<div view.getrenderattributestring>
		...
		<div view.getrenderattributestring>
			<# if ( 'image' === settings.flip_box_graphic &&  settings.image_front.url !=='' ) {
				...
				<div class="ube-flip-flip-image d-inline-block">
					<img src="https://muhammad-saad8.github.io/realestate/wp-content/plugins/ultimate-bootstrap-elements-for-elementor/templates/elements-view/{{{image_front_url}}}">
				</div>
			<# } #>
			...
			<# if (  settings.description_front !=='' ) { #>
				...
				<div view.getrenderattributestring>{{{settings.description_front}}}</div>
			<# } #>
		</div>
	</div>
	...
	<div view.getrenderattributestring>
		...
		#>
			<div class="ube-flip-flip-image d-inline-block">
				<img src="https://muhammad-saad8.github.io/realestate/wp-content/plugins/ultimate-bootstrap-elements-for-elementor/templates/elements-view/{{{image_back_url}}}">
			</div>
		<# } #>
		...
		<# if ( settings.description_back !=='' ) { #>
			...
			<div view.getrenderattributestring>{{{settings.description_back}}}</div>
		<# } #>
