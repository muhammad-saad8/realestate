...
#>
<a href="https://muhammad-saad8.github.io/realestate/wp-content/plugins/ultimate-bootstrap-elements-for-elementor/templates/elements-view/{{ settings.link.url }}" view.getrenderattributestring>
	<# if ((iconHTML.rendered) && (settings.icon_align === 'left')) { #>
		<span class="ube-btn-icon">{{{ iconHTML.value }}}</span>
	<# } #>
	<span view.getrenderattributestring>{{{ settings.text }}}</span>
