    ...
    <div view.getrenderattributestring>
        <div class="ube-ib-icon ube-image">
           ...
           <# var image = {
            ...
            #>
            <img src="https://muhammad-saad8.github.io/realestate/wp-content/plugins/ultimate-bootstrap-elements-for-elementor/templates/elements-view/{{{ image_url }}}">
            <#
            if ( settings.image_switcher!=='' ){
            var image_hover = {
            ...
            #>
            <img src="https://muhammad-saad8.github.io/realestate/wp-content/plugins/ultimate-bootstrap-elements-for-elementor/templates/elements-view/{{{ image_hover_url }}}">
            <#}#>
		...
		<# if (settings.image_box_title!=='' || settings.image_box_description!==''){ #>
            <div class="ube-ib-content">
				...
				<# if (settings.image_box_description!=='' && settings.description_position === 'inset'){ #>
                    <p view.getrenderattributestring>{{{settings.image_box_description}}}</p>
				<# } #>
            </div>
		<# } #>
    </div>
