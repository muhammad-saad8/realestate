...
if (!class_exists('ERE_Public')) {
    ...
    class ERE_Public
    {
        ...
        public function enqueue_styles()
        {
	        ...
	        wp_enqueue_style(ERE_PLUGIN_PREFIX . 'main', ERE_PLUGIN_URL . 'public/assets/scss/main/main' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
	        ...
	        wp_register_style(ERE_PLUGIN_PREFIX . 'property', ERE_PLUGIN_URL . 'public/assets/shortcode-css/property' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
           ...
           //wp_register_style(ERE_PLUGIN_PREFIX . 'property-carousel', ERE_PLUGIN_URL . 'public/templates/shortcodes/property-carousel/assets/css/property-carousel' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            wp_register_style(ERE_PLUGIN_PREFIX . 'property-carousel', ERE_PLUGIN_URL . 'public/assets/shortcode-css/property-carousel' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            ...
            wp_register_style(ERE_PLUGIN_PREFIX . 'property-gallery', ERE_PLUGIN_URL . 'public/assets/shortcode-css/property-gallery' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            ...
            wp_register_style(ERE_PLUGIN_PREFIX . 'property-advanced-search', ERE_PLUGIN_URL . 'public/assets/shortcode-css/property-advanced-search' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            ...
            wp_register_style(ERE_PLUGIN_PREFIX . 'property-search', ERE_PLUGIN_URL . 'public/assets/shortcode-css/property-search' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            ...
            wp_register_style(ERE_PLUGIN_PREFIX . 'property-search-map', ERE_PLUGIN_URL . 'public/assets/shortcode-css/property-search-map' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            ...
            wp_register_style(ERE_PLUGIN_PREFIX . 'property-mini-search', ERE_PLUGIN_URL . 'public/assets/shortcode-css/property-mini-search' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            ...
            wp_register_style(ERE_PLUGIN_PREFIX . 'property-slider', ERE_PLUGIN_URL . 'public/assets/shortcode-css/property-slider' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            ...
            wp_register_style(ERE_PLUGIN_PREFIX . 'property-type', ERE_PLUGIN_URL . 'public/assets/shortcode-css/property-type' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            ...
            wp_register_style(ERE_PLUGIN_PREFIX . 'archive-property', ERE_PLUGIN_URL . 'public/assets/scss/archive-property' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
	        ...
	        wp_register_style(ERE_PLUGIN_PREFIX . 'single-property', ERE_PLUGIN_URL . 'public/assets/scss/single-property' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
            ...
            wp_register_style(ERE_PLUGIN_PREFIX . 'dashboard', ERE_PLUGIN_URL . 'public/assets/scss/dashboard' . $min_suffix . '.css', array(), ERE_PLUGIN_VER, 'all');
        ...
        public function enqueue_scripts()
        {
	        ...
	        wp_enqueue_script(ERE_PLUGIN_PREFIX . 'main', ERE_PLUGIN_URL . 'public/assets/js/ere-main' . $min_suffix . '.js', array('jquery', 'wp-util', 'jquery-validate','jquery-ui-core','jquery-ui-slider','jquery-ui-dialog','jquery-ui-sortable','jquery-ui-touch-punch','bootstrap','bootstrap-tabcollapse'), ERE_PLUGIN_VER, true);
