...
_.each( settings.items, function(value ) {
	...
	if (value.image_marker.url!=='') {
		marker_html = '<img src="https://muhammad-saad8.github.io/realestate/wp-content/plugins/ultimate-bootstrap-elements-for-elementor/templates/elements-view/'+ value.image_marker.url +'">';
	}

    var popup_html                = '</p>
<div class="card">';
    if (value.image.url!==''){
      popup_html+='<img src="https://muhammad-saad8.github.io/realestate/wp-content/plugins/ultimate-bootstrap-elements-for-elementor/templates/elements-view/'+ value.image.url +'">';
    }
...
#>
<div view.getrenderattributestring></div>