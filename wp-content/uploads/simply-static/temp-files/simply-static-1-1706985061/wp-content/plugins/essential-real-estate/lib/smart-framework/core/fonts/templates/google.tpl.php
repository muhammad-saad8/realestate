                ...
                <div class="gsf-font-item" data-category="{{item.category}}" data-name="{{item.family}}" style="display: none">
                    ...
                    <div class="gsf-font-item-action">
                        <a href="https://www.google.com/fonts/specimen/{{item.family.replace(' ','+')}}" target="_blank"
                           title="<br />
<b>Fatal error:  Uncaught Error: Call to undefined function esc_attr_e() in D:\PORTFOLIO\htdocs\realestate\wp-content\plugins\essential-real-estate\lib\smart-framework\core\fonts\templates\google.tpl.php:18
Stack trace:
#0 {main}
  thrown in <b>D:\PORTFOLIO\htdocs\realestate\wp-content\plugins\essential-real-estate\lib\smart-framework\core\fonts\templates\google.tpl.php on line <b>18<br />
</script>