	...
	<div class="col-lg-9 ere-dashboard-content">
		<div class="ere-my-profile">
			<div class="card ere-card ere-card-account-settings">
                <div class="card-header"><h5 class="card-title m-0"><?php echo esc_html__('Account Settings', 'essential-real-estate'); ?></h5></div>
			...
			<div class="card ere-card ere-card-change-password mt-4">
                <div class="card-header"><h5 class="card-title m-0"><?php echo esc_html__('Change password', 'essential-real-estate'); ?></h5></div>
