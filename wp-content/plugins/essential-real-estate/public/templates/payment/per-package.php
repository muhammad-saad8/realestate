...
<div class="row">
    <div class="col-md-4 col-sm-6">
        <div class="ere-payment-for card ere-card ere-package-item">
            <div class="card-header"><h5 class="card-title m-0"><?php esc_html_e('Selected Package', 'essential-real-estate'); ?></h5></div>
            <ul class="list-group p-0">
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <?php esc_html_e('Package', 'essential-real-estate'); ?>
                    <span class="badge"><?php echo esc_html(get_the_title($package_id)) ; ?></span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <?php esc_html_e('Package Time:', 'essential-real-estate'); ?>
            <span
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <?php esc_html_e('Listing Included:', 'essential-real-estate'); ?>
        <span class="badge"><?php if ($package_unlimited_listing == 1) {
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <?php esc_html_e('Featured Listing Included:', 'essential-real-estate'); ?>
            <span class="badge"> <?php echo esc_html($package_featured_listings); ?></span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <?php esc_html_e('Total Price:', 'essential-real-estate'); ?>
            <span class="badge"><?php echo wp_kses_post(ere_get_format_money($package_price)) ; ?></span>
                </li>
