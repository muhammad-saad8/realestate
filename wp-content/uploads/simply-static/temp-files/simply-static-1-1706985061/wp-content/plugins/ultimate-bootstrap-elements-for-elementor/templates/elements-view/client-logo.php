...
<{{{tag_html}}} {{{ view.getRenderAttributeString( 'item_class' ) }}}>
	<#	if ( settings.client_logo_logo.url !== '' ) { #>
		<img src="https://muhammad-saad8.github.io/realestate/wp-content/plugins/ultimate-bootstrap-elements-for-elementor/templates/elements-view/{{{ settings.client_logo_logo.url }}}">
	<# }#>
{{{tag_html}}}
</div>