...
if (!class_exists('GSF_Inc_Admin_Taxonomy')) {
	class GSF_Inc_Admin_Taxonomy
	{
		...
		public function ajaxMetaForm() {
            ...
            check_ajax_referer('gsf_term_meta');
		...
		public function termMetaAddDisplay($taxonomy) {
			?>
			<div class="gsf-term-meta-wrapper gsf-term-meta-add-new" data-nonce="<?php echo esc_attr(wp_create_nonce('gsf_term_meta')) ?>" data-taxonomy="<?php echo esc_attr($taxonomy); ?>">
		...
		public function termMetaEditDisplay($term, $taxonomy) {
			...
			<tr class="form-field">
				<td colspan="2" style="padding: 0">
					<div class="gsf-term-meta-wrapper gsf-term-meta-edit" data-nonce="<?php echo esc_attr(wp_create_nonce('gsf_term_meta')) ?>">
